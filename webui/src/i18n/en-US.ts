const enUS = {
  ...
  buttons: {
    ...
    mobileAssignOpenPicker: "Pick Target Menu",
    mobileAssignPickerTitle: "Place Button",
    mobileAssignSelectedLabel: "Selected Button",
    mobileAssignTargetMenu: "Target menu",
    mobileAssignTargetRow: "Target row",
    mobileAssignConfirm: "Place Now",
    mobileAssignRowLabel: "Row {index} ({count} buttons)",
    mobileAssignNewRow: "New row {index}",
    showBank: "Show button bank",
    hideBank: "Hide button bank",
  ...
  workflow: {
    ...
    saveSuccessWithDataRefMigration: "Workflow “{name}” saved. Migrated {count} legacy data edge(s) to parameter references.",
    controlFanoutBlocked: "Cannot save: node {source} output {output} connects to multiple nodes [{targets}]. Use separate branch outputs or connect the nodes as one explicit sequence.",
    tester: {
      run: "Run Test",
      analyze: "Check",
      view: "View Result",
      ...
      analyzeFailed: "Check failed: {error}",
      resultTitle: "Test Result",
      analyzeTitle: "Workflow Check Result",
      analyzeOk: "Check passed. No obvious issues found.",
      analyzeWarnings: "Check completed with {count} warning(s).",
      analyzeErrors: "Check failed with {count} error(s).",
      ...
      modeGeneric: "Trigger: {mode}",
      triggerNodePlaceholder: "Trigger Node (Optional)",
      commandTextPlaceholder: "Command text, e.g. /cs hello",
      keywordTextPlaceholder: "Message text for keyword match",
      buttonIdPlaceholder: "Button ID, e.g. btn_xxx",
      noExtraInput: "No extra input needed in this mode",
      missingCommandText: "Please input command text first",
      missingKeywordText: "Please input message text first",
      missingButtonId: "Please input button ID or select a trigger node",
      nodeValueEmpty: "empty",
      triggerNodeMatched: "Matched Trigger Node",
      preview: "Preview Mode",
      obsId: "Log ID",
      resultPayload: "Execution Result",
      tracePayload: "Execution Trace Snapshot",
    ...
    mobileActions: {
      ...
      dockHint: "Use the bottom dock for quick insert, fullscreen, and more actions.",
      showPalette: "Show Nodes",
      hidePalette: "Hide Nodes",
      quickInsert: "Insert",
      enterFsShort: "FS",
      exitFsShort: "Exit",
      nodeHint: "Double-tap a node to edit settings",
    },
    ...
    nodeModal: {
      ...
      params: {
        ...
        upstreamInlinePlaceholder: "Select node output (expand node first)",
        upstreamInlinePathPlaceholder: "Optional subpath, e.g. raw_event.message.text",
        useUpstreamOutput: "Use Node Output",
        runtimeVariablePlaceholder: "Select runtime variable…",
        useRuntimeVariable: "Use Variable",
      ...
      wiring: {
        ...
        clear: "Clear",
        saveAsVariable: "Save As Variable",
        saveAsVariableNoSource: "Select an upstream output first.",
        saveAsVariableActionMissing: "set_variable action definition is missing; auto insert is unavailable.",
        saveAsVariableSuccess: "Inserted set_variable node and switched current input to variable ref: {variable}",
        saveAsVariablePartial: "Inserted set_variable node: {variable}. Please review control connections.",
  ...
  logs: {
    ...
    stats: {
      ...
      failureTrend: "Recent Failure Trend",
      last24h: "Last 24h",
    ...
    detail: {
      ...
      failureSourceNode: "Node Execution Failure",
      failureSourceWorkflow: "Workflow Execution Failure",
      failureNode: "Failed Node",
      failureAt: "Failure Time",
      failureRuntime: "Runtime Snapshot",
      failureTrigger: "Trigger Snapshot",
      error: "Error",
      nodes: "Node Trace",
      inputs: "Inputs",
      outputs: "Outputs",
  ...
  bot: {
    ...
    tokenPlaceholder: "Enter a new token to overwrite the saved token; leave empty to keep it",
    tokenFromEnv: "Using token from Worker environment variables.",
    tokenFromConfig: "Using a saved token; it is hidden for security.",
    tokenMissing: "Token is missing; Telegram actions will fail.",
    profileTitle: "Bot Info & Profile",
    getMe: "Get Bot Info",
    getMeFailed: "Get bot info failed: {error}",
    botId: "Bot ID",
    botUsername: "Username",
    botName: "Name",
    canJoinGroups: "Can Join Groups",
    profileDescriptionLabel: "Description",
    profileDescriptionPlaceholder: "Description shown on the bot profile page",
    shortDescriptionLabel: "Short Description",
    shortDescriptionPlaceholder: "Short description shown in bot profile",
    languageCodeLabel: "Language Code",
    languageCodePlaceholder: "Optional, e.g. zh-cn / en",
    saveProfile: "Save Description",
    profileSaveSuccess: "Bot descriptions saved",
    profileSaveFailed: "Save bot descriptions failed: {error}",
    menuButtonTypeLabel: "Menu Button Type",
    menuButtonCommands: "Commands",
    menuButtonWebApp: "WebApp",
    menuButtonDefault: "Default",
    menuButtonTextLabel: "Button Text",
    menuButtonTextPlaceholder: "Open App",
    menuButtonUrlLabel: "WebApp URL",
    menuButtonUrlPlaceholder: "https://example.com/app",
    menuButtonChatLabel: "Chat ID",
    menuButtonChatPlaceholder: "Empty means global menu button",
    setMenuButton: "Set Menu Button",
    menuButtonSetSuccess: "Menu button set",
    menuButtonSetFailed: "Set menu button failed: {error}",
    ...
    webhookDeleteSuccess: "Webhook deleted",
    webhookDeleteFailed: "Delete webhook failed: {error}",
